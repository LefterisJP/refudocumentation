...
=guse()=. There the p object is moved inside a couple object. If the couple object is not used any further then
both it and the person object will get destroyed.
